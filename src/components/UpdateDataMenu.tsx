...
import { initialUpdateDataState, updateDataReducer, type UpdateCounts } from '@/lib/updateDataState';

export function UpdateDataMenu({ onUpdated }: { onUpdated?: () => void | Promise<void> }) {
  const [open, setOpen] = useState(false);
  const [state, dispatch] = useReducer(updateDataReducer, initialUpdateDataState);
