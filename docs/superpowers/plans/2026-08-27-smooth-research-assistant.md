...
- [x] **Step 1: Write the failing latest-intent test**
...
- [x] **Step 3: Implement deterministic date intent and prompt context**
...
- [x] **Step 1: Write a failing reasoning-only recovery test**
...
- [x] **Step 3: Implement bounded provider recovery**
...
- [x] **Step 4: Prevent empty cache entries**
...
- [x] **Step 1: Write failing storage-bound tests**
...
- [x] **Step 3: Implement pure session utilities and hook integration**
...
- [x] **Step 4: Add server history validation**
...
- [x] **Step 1: Build the focused chat shell**
...
- [x] **Step 2: Render smooth messages and citations**
...
- [x] **Step 3: Upgrade the composer and filters**
...
- [x] **Step 4: Add restrained motion and accessibility**
...
- [x] **Step 5: Run complete release gates**
